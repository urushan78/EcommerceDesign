<?php
    ...
    $query ="SELECT * FROM PRODUCT WHERE CATEGORY='deli' order by PRODUCT_ID ASC";
    ...
    if(isset($_POST['sort'])){
        ...
        $select ="SELECT * FROM PRODUCT WHERE CATEGORY='deli'";
        ...
        <div id="arrange">
            ...
            ?>
                <div class="boxes">
                    ...
                    <div class="buy-btn">
                        <a href="productview.php?PRODUCT_ID=<?php echo $eachrow["PRODUCT_ID"];?>" style="">Buy Now</a>
                    </div>
                </div>
            <?php
            }
