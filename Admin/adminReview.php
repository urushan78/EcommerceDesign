<?php
    ...
    if(!isset($_SESSION['role']) || $_SESSION['role']!='Admin')
        ...
        {
            $delete = "Successfully Record Deleted";
        }
?>
<!DOCTYPE html>
<html lang="en"> 
    ...
    <div class="nav">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="adminReview.php" class="option  active"><i class="fas fa-comment-dots"></i><span class="go">Review</span></a></li>
        ...
        <table class="table js-sort-table table-secondary table-striped table-hover" id="demo1">
            <thead>
              <tr style="background-color:black;">
                ...
                <th scope="col" class="js-sort-date">Product Name</th>
              ...
              ?>
                ...
                <div class="col-9 col-sm-5"></div>
                  ...
                  <td><a href="sub_page/viewProduct.php?view=<?php echo $product_id;?>"><?php echo $row['NAME'];?></a></td>
