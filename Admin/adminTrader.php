		...
		<div class="nav">
            ...
            <div class="sidebar">
				...
				<ul>
					...
					<li><a href="#" class="option active"><i class="fas fa-portrait"></i> <span class="go">Trader</span></a></li>
            ...
            <table class="table js-sort-table table-secondary table-striped table-hover" id="demo1">
                <thead>
                  <tr style="background-color:black;">
                    ...
                    <th scope="col" class="js-sort-date">Email</th>
                    <th scope="col">Number of Shop</th>
                  ...
                  <tbody>
                    <?php
                      ...
                      $query2 = oci_parse($conn,"SELECT * FROM TRADER_REQUEST");
                      $run = oci_execute($query2);
                    if($run){
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="sub_page/viewRequest.php?view=<?php echo $row['0'];?>">View</a> / 
                        <a href="sub_page/deleteTrader.php?delete=<?php echo $row['0'];?>">Delete</a>
                      </td>
                    </tr>
                    <?php } }?>
                  </tbody>
        ...
        <?php }?>
                  ...
                  <thead>
                    <tr style="background-color:black;">
                      ...
                      <th scope="col" class="js-sort-date">Insert Date</th>
                      <th scope="col">Operation</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['6'];?></td>
                      <td>
                        <a href="sub_page/viewTraderRequest.php?view=<?php echo $row['0'];?>">View</a>
                      </td>
                    </tr>
                    <?php } }?>
                  </tbody>
