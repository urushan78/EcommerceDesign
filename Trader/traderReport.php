	...
	<section id="home">
                ...
                <div class="nav">
                    ...
                    <div class="sidebar">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="option active"><i class="fas fa-chart-line"></i> <span class="go">Report</span></a></li>
            ...
            <section id="orderDetails">
                <div class="first_section" style="margin:0 12px;">
                    <h1 style="text-align:center; padding: 35px 0; margin-top:2em;">Weekly Report</h1>
                        <table  class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>Weekly</td>
                                    <td><?php echo date("d/m/Y", strtotime("previous monday"))?> - <?php echo date("d/m/Y", strtotime("next monday")) ?></td>
                                    <td><a href="sub_page2/weeklyFreport.php">View</a></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Weekly</td>
                                    <td><?php echo date("d/m/Y", strtotime("previous monday"))?> - <?php echo date("d/m/Y", strtotime("next monday")) ?></td>
                                    <td><a href="sub_page2/weeklySreport.php">View</a></td>
                                </tr>
                        ...
                        <div class="first_section" style="margin:0 12px;">
                    <h1 style="text-align:center; padding: 35px 0;">Monthly Report</h1>
                        <table  class="table">
                            <thead>
                                <tr style="background-color:black; color:white;">
                                <th scope="col">#</th>
                                ...
                                <tr>
                                    ...
                                    <td>Financial Report</td>
                                    <td>Monthly</td>
                                    <td><?php echo date("M/Y", strtotime("this month"))?> - <?php echo date("M/Y", strtotime("next month")) ?></td>
                                    <td><a href="sub_page2/monthlyFreport.php">View</a></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Monthly</td>
                                    <td><?php echo date("M/Y", strtotime("this month"))?> - <?php echo date("M/Y", strtotime("next month")) ?></td>
                                    <td><a href="sub_page2/monthlySreport.php">View</a></td>
                                </tr>
