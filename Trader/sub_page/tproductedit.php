...
<html>
    ...
    <?php
        if(isset($_GET['PRODUCT_ID']))
        {
            ...
            $execute=oci_parse($conn,"SELECT * FROM PRODUCT_REQ WHERE PRODUCT_ID='$PRODUCT_ID'");
            $run = oci_execute($execute);
            ...
            $mDate = date("MM/DD/YY", strtotime($cell['5']));
            $eDate = date("MM/DD/YY", strtotime($cell['8']));
        }
   ?>
        <div class="pdetails">
                ...
                <div>
                    ...
                    <div class="align">
                        ...
                        <div id="rightAlign">
                            ...
                            Expiry Date <br> <input type="date" name="Expiry_date" placeholder="mm/dd//yy" required value="<?php echo $mDate;?>"> <br><br>
                            ...
                            <div>
                                Minimum Order
                                <input type="number" name="Minimum_order" min="1" max="1" value="1" required value="<?php echo $eDate;?>"> <br><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <select name="shoptype" required style="margin-bottom:1em;">
                        ...
                        <?php 
                            ...
                            if($run)
                            {
                                ...
                                {
                        ?>
                        <option value="<?php echo $row['0'];?>" <?php if($row['0']==$cell['14']){echo "selected";}?> ><?php echo $row['1'];?></option>
